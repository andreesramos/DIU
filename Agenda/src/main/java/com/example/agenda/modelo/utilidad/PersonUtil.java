...
public class PersonUtil {
    ...
    public static ArrayList<PersonVO> getPersonVO(ArrayList<Person> personas) {
        ...
        for(Person persona : personas) {
            personVOs.add(new PersonVO(persona.getFirstName(), persona.getLastName(), persona.getStreet(), persona.getPostalCode(), persona.getCity(), persona.getBirthday()));
        }
        return personVOs;
    }
    ...
    public static ArrayList<Person> getPerson(ArrayList<PersonVO> personVOs) {
        ...
        for(PersonVO personVO : personVOs) {
            persons.add(new Person(personVO.getFirstName(), personVO.getLastName(), personVO.getStreet(), personVO.getPostalCode(), personVO.getCity(), personVO.getBirthday()));
        }
        return persons;
    }
}
