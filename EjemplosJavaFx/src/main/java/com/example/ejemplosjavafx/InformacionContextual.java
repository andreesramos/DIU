...
public class InformacionContextual extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imgCerveza = new Image("file:resources/imagenes/cerveza.jpg", 50, 50, true, true);
            ...
            Image imgApagar = new Image("file:resources/imagenes/botonApagar.png", 50, 50, true, true);
